...
echo_and_run cd "/home/ubuntu/phil_catkin_ws/src/rosserial/rosserial_client"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/ubuntu/phil_catkin_ws/src/rosserial/rosserial_client/setup.py" \
    build --build-base "/home/ubuntu/phil_catkin_ws/build/rosserial/rosserial_client" \
    install \
    $DESTDIR_ARG \
